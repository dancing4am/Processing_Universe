...
class Planet {
  ...
  public int _planetColor = color(_r, _g, _b);
...
public void earth_to_sun(int newDist) {
  earthDist = newDist;
  earthRotation = new PVector(earthDist, 0);
}

public void moon_to_earth(int newDist) {
  moonDist = newDist;
  moonRotation = new PVector(moonDist, 0);
}

public void earth_speed(int speed) {
  earthSpeed = speed;
}

public void moon_speed(int speed) {
  moonSpeed = speed;
}

public void play_animation(boolean flag) {
  isPlaying = flag;
}
...
public void planet_size(int size) {
  planetSize = size;
}

public void orbit_speed(int speed) {
  planetOrbitSpeed = speed;
}

public void rotate_speed(int speed) {
  planetRotateSpeed = speed;
}

public void dist_to_sun(int dist) {
  distToSun = dist;
}

public void has_a_moon(boolean flag) {
  hasAMoon = flag;
}

public void dist_to_moon(int dist) {
  distToMoon = dist;
}

public void moon_size(int size) {
  planetMoonSize = size;
}

public void child_speed(int size) {
  planetMoonSize = size;
}
...
public void setupStars() {
  ...
  for (int i=0; i< 1000; i++) {
    ...
    y = PApplet.parseInt(random(width));
